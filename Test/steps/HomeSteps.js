...
cucumber_1.defineSupportCode(function (_a) {
    ...
    Then(/^I should see all course information in coursedetails page$/, function (table) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            chai_1.assert.deepEqual(localtable, table.rows(), "The DataSource is not correct");
            return [2 /*return*/];
        });
    }); });
    Given(/^I enter text in Search from external data Source$/, function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
